...
} else if (randomNumber >= 33 && randomNumber < 60 && firstName != null && secondName != null && firstName != "" && secondName != ""){
    alert (`Результат совместимости имен ${firstName} и ${secondName} равен ${randomNumber}Совместимость хорошая, но может быть и лучше.`)
} else if (randomNumber >= 60 && firstName != null && secondName != null && firstName != "" && secondName != ""){
